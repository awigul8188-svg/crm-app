...
function StatCard({ label, value, color, icon, sub, warn }) {
  return (
    <div style={{ background:'#fff', borderRadius:14, border:`1px solid ${warn?'#fecaca':'#f1f5f9'}`, padding:'14px 18px', position:'relative', overflow:'hidden', background:warn?'#fff5f5':'#fff' }}>
...
function InquiryAssignModal({ inquiryId, onClose, onSaved }) {
  ...
  return createPortal(
    <div onClick={onClose} style={{ position:'fixed', inset:0, zIndex:99999, background:'rgba(0,0,0,0.55)', backdropFilter:'blur(4px)', display:'flex', alignItems:'center', justifyContent:'center', padding:16 }}>
      <div onClick={e=>e.stopPropagation()} style={{ background:'#fff', borderRadius:20, boxShadow:'0 24px 80px rgba(0,0,0,0.25)', width:'100%', maxWidth:680, maxHeight:'90vh', display:'flex', flexDirection:'column', fontFamily:'"Plus Jakarta Sans",sans-serif' }}>
        ...
        <div style={{ background:'#fff', borderRadius:14, border:'1px solid #f1f5f9', overflow:'hidden' }}>
          <div style={{ overflowX:'auto' }}>
            <table style={{ width:'100%', borderCollapse:'collapse', fontSize:12 }}>
              ...
              <tbody>
                {filtered.map((p, i) => (
                  <tr key={p.requirement_id} style={{ borderBottom:'1px solid #f1f5f9', background:p.is_delayed?'#fff5f5':p.is_over_selling?'#fff7ed':i%2===0?'#fff':'#fafbfc' }}>
    ...
    <div style={{ padding:28, maxWidth:1400, fontFamily:'"Plus Jakarta Sans",sans-serif' }}>
      ...
      {activeTab==='dashboard' && ms && (
        <div>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:12, marginBottom:20 }}>
            <div style={{ background:'#fff', borderRadius:14, border:'1px solid #f1f5f9', padding:'16px 20px' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:20, marginBottom:20 }}>
            ...
            <div style={{ background:'#fff', borderRadius:14, border:'1px solid #f1f5f9', padding:20 }}>
              <div style={{ fontFamily:'"Bricolage Grotesque",sans-serif', fontWeight:700, fontSize:14, color:'#0f172a', marginBottom:14 }}>Purchaser Performance</div>
              {!ms.byPurchaser?.length ? <div style={{ textAlign:'center', color:'#94a3b8', padding:24, fontSize:13 }}>No purchasers assigned yet</div> : ms.byPurchaser.map(p => (
                <div key={p.id} style={{ display:'flex', alignItems:'center', gap:10, padding:'10px 0', borderBottom:'1px solid #f8fafc' }}>
                  ...
                  <div style={{ flex:1 }}>
                    ...
                    <div style={{ height:4, background:'#f1f5f9', borderRadius:4, marginTop:3 }}>
          ...
          <div style={{ background:'#fff', borderRadius:14, border:'1px solid #f1f5f9', padding:20 }}>
            ...
            {!ms.recentQuotes?.length ? <div style={{ textAlign:'center', color:'#94a3b8', padding:24 }}>No quotes yet</div> :
              ms.recentQuotes.map((q, i) => {
                ...
                return (
                  <div key={i} style={{ display:'flex', alignItems:'center', gap:10, padding:'8px 0', borderBottom:'1px solid #f8fafc', background:isOver?'#fff5f5':'' }}>
      ...
      {activeTab==='notifications' && (
        <div>
          ...
          {notifications.length===0 ? <div style={{ background:'#fff', borderRadius:14, border:'1px solid #f1f5f9', padding:60, textAlign:'center', color:'#94a3b8' }}><div style={{ fontSize:36, marginBottom:10 }}>📭</div>No new part notifications</div> : (
